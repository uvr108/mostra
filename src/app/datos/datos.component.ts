...
export class DatosComponent implements OnInit {
  ...
  cabecera: Array<string> = ['sfile','latitud','longitud','dep','m1_magnitud',
  ...
  carga_datos(period:string, zona:Array<string>) {
    ...
    var orderBy = {'order': ['sfile','version'] , 'tipo':'desc'};
    ...
    const mensaje: Message = {'command': 'listar','tipo': 'rethink', 
      'message': [{'command': 'listar', 'message': {'table': 'triggers', 'option': 'select', 'betweenISO':between,'orderBy': orderBy}}]};
